...
function draw() {
  ...
  for (var y = 0; y < height; y += 10) {
    for (var x = 0; x < width; x += 10) {
      ...
      var d = noise(x, y, random(mouseX)/val)*(TWO_PI*6.0);
       line(x, y+vol*n, (sin(d)*100)+x, (cos(d)*100)+y)
      ellipse(x*d, y, 3+vol*n, 3+vol*n/5)
    }
  }
  pop();
 ...
 vol += (v-vol)/3;   
  ...
  beginShape();
  vertex(225,560);
  bezierVertex(210-q,575+q, 190-q,580, 205-q,560+q);
  bezierVertex(205-q,555, 185,540, 175,530);
  ...
  bezierVertex(515,180, 555,220, 530,290+q);
  bezierVertex(550, 365,  525,345+q, 545,350+q);
  bezierVertex(515,390+q, 545,410, 490,455);
  bezierVertex(455,465, 455,495, 440,535+q);
  endShape();
  pop();
  ...
  push();
      fill('black');
      ellipse(292.5,470-vol*n/2, 95-vol*0.5,20+q);
    ...
    beginShape();
    fill('white');
    ellipse(292.5, 465-vol*n/6, 100,15-vol*10);
  endShape();
    fill(241,230,216);
    beginShape();
      vertex(240-vol*n,465-vol*n/2);
      bezierVertex(260,440, 280,450-vol*n/2, 290,455-vol*n/2);
      bezierVertex(305,450-vol*n/2, 320,440, 345+vol*n,465-vol*n/2);
    endShape(CLOSE);
  pop();
  //teeth
  push();
  ...
  strokeWeight(1);
  beginShape();
    vertex(260,470-vol*n);
    quadraticVertex(270,490-vol*n/6, 270,470-vol*n);
  endShape();
  beginShape();
    vertex(310,470-vol*n);
    quadraticVertex(310,490-vol*n/6, 320,470-vol*n);
  endShape();
  
  beginShape();
    vertex(270,470-vol*n);
    bezierVertex(270,485-vol*n, 290,485-vol*n, 290, 470-vol*n);
  endShape();
  
  beginShape();
    vertex(310,470-vol*n);
    bezierVertex(310,485-vol*n, 290,485-vol*n, 290, 470-vol*n);
  endShape();
  
  beginShape();
    vertex(260,470-vol*n);
    bezierVertex(260, 485-vol*n, 250,480-vol*n, 250-vol*n/2,470-vol*n);
  endShape();
  
   beginShape();
    vertex(320,470-vol*n);
    bezierVertex(320, 485-vol*n, 330,485-vol*n, 330+vol*n/2,470-vol*n);
  endShape();
  pop();
  ...
  beginShape();
  line(280+vol*n/5,350+vol*n, 275-vol*n/5,380+vol*n/5);
  line(305-vol*n/5,355+vol*n, 310+vol*n/5,380+vol*n/5);
  vertex(265,405);
  bezierVertex(250-vol*n,425, 285,430, 290,440+vol*12);
  vertex(295,440+vol*12);
  bezierVertex(305+vol*n,420, 330+vol*n,420, 315,405);
  endShape();
  pop();
  let sec = second();
  ...
  vertex(235,200);
  bezierVertex(230,180, 180,190, 190,240+q);
  bezierVertex(195,250, 195,290, 170,305);
  bezierVertex(160,320, 165,335, 175,345+q);
  bezierVertex(155,330, 145,310, 150,280);
  bezierVertex(145,315, 150,330, 160,350+q);
  bezierVertex(160,360, 160,360, 155,365);
  bezierVertex(145,370, 140,375, 135,390+q);
  bezierVertex(130,380, 140,365, 130,350);
  bezierVertex(135,330, 130,345, 135,360+q);
  ...
  bezierVertex(295,340, 310,360+q, 325,365-q);
  bezierVertex(310,355-q, 315,335, 330,315);
  ...
  bezierVertex(390,260, 380, 290, 405,320+q);
  bezierVertex(415,330,410,360, 425,395+q);
  bezierVertex(410,355, 475,330, 440,290);
  bezierVertex(430,280, 435,270, 445,240);
  bezierVertex(450,245, 440,270, 450,295);
  bezierVertex(460,315+q, 450,335+q, 440,350);
  bezierVertex(435,360+q, 445,380+q, 450,405+q);
   bezierVertex(475,390+q, 460,340+q, 485, 320);
  bezierVertex(470,150, 330,80, 230,150+q);
  endShape();
  pop();
